#!/usr/bin/env php
<?php
function conletra($numero, $singular, $plural, $subfijo) {
 ...
 if ($numero >= 2) $texto = " ".$plural." ".substr(ltrim(strstr($numero, "."), "."), 0, 2)."/100 ".$subfijo; //calcula los decimales para más de un peso
 elseif ($numero >= 1) $texto = " ".$singular." ".substr(ltrim(strstr($numero, "."), "."), 0, 2)."/100 ".$subfijo; //calcula los decimales para UN peso
 elseif ($numero >= 0) $texto = "cero ".$plural." ".substr(ltrim(strstr($numero, "."), "."), 0, 2)."/100 ".$subfijo; //texto completo para cantidad CERO
...
print(preg_replace('/\s+/', ' ',conletra($argv[1],$argv[2],$argv[3],$argv[4]))."\n");
?>
